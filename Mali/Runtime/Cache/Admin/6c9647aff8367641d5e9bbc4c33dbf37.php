...
<div class="main-container" id="main-container">
    ...
    <div class="main-content">
        <div class="row">
            ...
            <div class="col-md-8" >
                <form action="/www/mali/index.php/Admin/Index/doUpdateType" method="post" role="form">
                    <input type="hidden" class="form-control" name="type_id" placeholder="请输入名称" value="<?php echo ($data["type_id"]); ?>">
                    <div class="form-group">
                        <label for="name"><h4>修改分类名字:</h4></label>
                        <input type="text" class="form-control" name="type_name" placeholder="请输入名称" value="<?php echo ($data["type_name"]); ?>">
                    </div>
