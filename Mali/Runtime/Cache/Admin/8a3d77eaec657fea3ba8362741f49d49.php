        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 class="header smaller lighter blue"> <a href="/mali/index.php/Admin/MyGame/addGame">添加游戏</a></h3>
                            ...
                            <div class="table-responsive">
                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                            ...
                                            <td>
                                                <a href="#"><img style="width: 50px;" src="/mali/Public/Upload/MyGame/<?php echo ($vo["my_game_pic"]); ?>"></a>
                                            </td>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                    <a class="green" href="/mali/index.php/Admin/MyGame/detail?id=<?php echo ($vo["my_game_id"]); ?>">
                                                        <i class="icon-edit bigger-130"></i>
                                                    </a>
                                                    <a class="blue" href="/mali/index.php/Admin/MyGame/update?id=<?php echo ($vo["my_game_id"]); ?>">
                                                        <i class="icon-zoom-in bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="/mali/index.php/Admin/MyGame/del?id=<?php echo ($vo["my_game_id"]); ?>">
