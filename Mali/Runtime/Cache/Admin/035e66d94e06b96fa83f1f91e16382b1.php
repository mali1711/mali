                                        ...
                                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                    <a class="blue" href="/mali/index.php/Admin/Article/detailsArticle?id=<?php echo ($vo["article_id"]); ?>">
                                                        <i class="icon-zoom-in bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="/mali/index.php/Admin/Article/delArticle?id=<?php echo ($vo["article_id"]); ?>">
