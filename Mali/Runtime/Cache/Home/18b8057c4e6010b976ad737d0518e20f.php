    ...
    <div class="bs-example" data-example-id="thumbnails-with-custom-content">
        ...
        <div class="row">
            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="col-sm-6 col-md-3">
                <div class="thumbnail">
                    <a href="#">
                        <img data-src="holder.js/100%x200" alt="100%x200" style="height: 200px; width: 100%; display: block;" src="/mali/Public/Upload/MyGame/<?php echo ($vo["my_game_pic"]); ?>" data-holder-rendered="true">
                    </a>
                    <div class="caption">
